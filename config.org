...
- [[#org-mode][ORG MODE]]
  ...
  - [[#org-google-cal-sync][Org google cal sync]]
...
* ABOUT THIS CONFIG
This is my personal Doom Emacs config.  Doom Emacs is a distribution of Emacs that uses the "evil" keybindings (Vim keybindings) and includes a number of nice extensions and a bit of configuration out of the box. This config is mainly based on [[https://gitlab.com/dwt1][Derek Taylor]] (DT) config. DT is a famous youtubeur among the emacs community and without his content I wouldn't use emacs today.
...
* NYAN MODE
Nyan mode shows you your buffer position in mode line. You can click on nyan cat to switch to corresponding position in current selected buffer.
#+BEGIN_SRC emacs-lisp
...
|------------+-------------------------+--------------------------------|
| SPC = a    | /Edit agenda file/      | ~/Org/agenda.org               |
| SPC = c    | /Edit doom config.org/  | ~/.config/doom/config.org"     |
| SPC = i    | /Edit doom init.el/     | ~/.config/doom/init.el"        |
| SPC = p    | /Edit doom packages.el/ | ~/.config/doom/packages.el"    |
| SPC = e a  | /Edit eshell aliases/   | ~/.config/doom/eshell/aliases" |
| SPC = e p  | /Edit eshell profile/   | ~/.config/doom/eshell/profile" |
...
#+END_SRC
** Org google cal sync
documentation: https://cestlaz.github.io/posts/using-emacs-26-gcal/#.WIqBWIqBud9vGAkud9vGAk
